...
input.addEventListener("input", () => {
  ...
  let age = getYearsSince(userInput);
  if (age < 13 || age > 200) {
...
function validatePasswordMatch() {
  let firstPassword = document.getElementById("passwordInput");
  let enterPassword = firstPassword.value
  let secondPassword = document.getElementById("passwordConfirmInput");
  let confirmPassword = secondPassword.value;
...
*/
let passwordInput1 = document.querySelector("#passwordInput");
passwordInput1.addEventListener("input", validatePasswordMatch);
let passwordInput2 = document.querySelector("#passwordConfirmInput");
